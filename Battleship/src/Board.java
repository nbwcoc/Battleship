    ...
    public void placeShips(Ship[] shipArray) {
        ...
        for (int x = 0; x < shipArray.length; x++) {
            ...
            while (shipCounter < shipArray[x].getLength()) {
                ...
                // the hashmap and it is within the bounds, then we will place
                // the ship
                if (!shipLayer.containsKey(xy)
                    ...
                    // if we can not place a ship, create new coordinates and
                    // direction
        ...
        // shipLayer.forEach((key, value) -> System.out.println(key.toString() +
        // ":" + value.toString()));
    }
